...
diet.seqs.file <- "/gscratch/coenv/mball3/WADE003-arctic-pred/rawdata/CO1P1"
...
## for CO1 trimLeft = 27, truncLen=c()
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, trimLeft = 30, truncLen=c(290, 280),
...
### Save data
save(seqtab.nochim, freq.nochim, track, out, taxa, file = "WADE003-arcticpred_dada2_QAQC_CO1P1_output.Rdata")
